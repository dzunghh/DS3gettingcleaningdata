...
# with the data to indicate all the variables and summaries calculated, along with units, 
...
setwd("D:/OneDrive/MOOCs/MOOC Data Sciences_JHU/Course 3 Getting and Cleaning Data/Course Project/DS3gettingcleaningdata")


#download file
download.file("https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip",
              destfile = 'ds3project.zip', method = 'curl', quiet = T)
unzip(zipfile = 'ds3project.zip')
...
meanSdData$activity <- factor(meanSdData$activityLabels,
        ...
        #make new column that considers the activityLabels column a factor of 6 levels,
